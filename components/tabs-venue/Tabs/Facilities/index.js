  ...
  return (
    <div className="details mt-5">
      <Row>
        ...
        <div className="forms">
          <div className="row">
            <div className="col-md-3">
              <Link legacyBehavior href="add-venue-facility">
                <button
                  type="submit"
                  class="ms-0 mt-4 btn btn-primary py-2 px-5"
                >
                  Add Venue Facility
                </button>
              </Link>
        ...
        <div className="table">
          <p className="pt-4">11 aside Pitch</p>
              ...
              <tr>
                ...
                <td className="text-capitalize">
                  <div className="layouts">
                    <span className="leyout-span"></span>
                  </div>
                </td>
                <td>3G Artificial</td>
                <td>
                ...
                <td>
                  <span className="bg-grey">Ruby</span>
                  <span className="bg-grey">Score</span>
                </td>
                <td>
                  <a
