    ...
    return (
        ...
        <section className="info container">
            <div className="card">
                ...
                <h5>Property to Rent in Dubai</h5>
                <p>
                    Interested to see what's on the market?
                </p>
                <Link legacyBehavior href="/dubai/properties/residential/lettings"><a><button className="default_btn">Yes, please</button></a></Link>
            </div>
            <div className="card">
