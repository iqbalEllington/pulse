     ...
     <div className="devider pb-0"></div>
      ...
      <div className="container">
        <div className="navigation breadcrumbs">
          ...
          <Link legacyBehavior href="/dubai/sellers/sell-your-properties-in-dubai"><a>Sell Your Properties in Dubai</a></Link>
        </div>
      </div>
      {/* ================================= Modules Banner ================================= */}
                ...
                <div className="accordion pt-4" id="accordionExample">
                  ...
                  <div className="accordion-item">
                    ...
                    <div id="collapse_8" className="accordion-collapse collapse" aria-labelledby="heading_8" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <p>Your broker will start to bring offers from prospective buyers to you. This is another point where having a very good relationship with your broker is key. Use information from past viewing feedback, similar property sales and an array of data points a good broker will provide to help you come to a decision. Once a verbal agreement is made, both you and the buyer will enter into contract stage, this process will be led by your broker.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    <div id="collapse_9" className="accordion-collapse collapse" aria-labelledby="heading_9" data-bs-parent="#accordionExample">
                      <div className="accordion-body">
                        <p>The Allsopp & Allsopp in-house sales progression team will be with you every step of the way to ease you through the sale process and make it as seamless as possible from start to finish. The No Objections Certificate (NOC) from the developer right through to the transfer.  They coordinate between you as a seller, the buyer, the developer and the banks involved. With all the experience they have gathered over the years they are extremely proactive and know the process inside out.  Your sales progressor will make sure all of your documents are in order before beginning the process in order to avoid delays.</p>
                      </div>
                    </div>
                  </div>
                </div>
