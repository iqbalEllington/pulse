                      ...
                      <tbody>
                        {events.map((value) => {
                          return <tr>
                            ...
                            <td>
                            <Link legacyBehavior href={"/registration/events/" + value.id + "/list"}>
                                  <a style={{ margin: "10px" }} className=" bg-l-yellow labelstyle">
                                    <FiEdit /> View & Register
                                  </a>
                                </Link>
                                <Link legacyBehavior href={"/registration/validation/validate"+"/"+value.id+"/"+value.attributes.referenceId}>
