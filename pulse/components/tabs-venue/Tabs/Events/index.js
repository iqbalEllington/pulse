      ...
      <Row>
        ...
        <div className="search border pb-5 mt-5 pt-5">
          <div className="d-flex justify-content-between header-title mb-4">
            ...
            <Link legacyBehavior href="event">
              <button class="p-2 btn btn-primary">Add Events</button>
            </Link>
          </div>
          <div className="forms">
            <form>
          ...
          <div className="table-responsive mt-5">
            <Table className="table-bordered">
              ...
              <tbody>
                <tr>
                  <td>Segments</td>
                  <td className="text-capitalize">Segments</td>

                  <td>
                    <span className="bg-grey">Score</span>
                    <span className="bg-grey">Score</span>
                  </td>
                  <td>
                  ...
                  <td>
                    ...
                    <button className="btn btn-danger py-2 px-5">Reject</button>
                  </td>
                  <td>
                    <button className="me-4 btn btn-primary py-2 px-5">
                      Approved
                    </button>
                    <button className="btn btn-danger py-2 px-5">
                      Pending
                    </button>
                  </td>
                  <td>
