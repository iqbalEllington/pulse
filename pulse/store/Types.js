...
export const UPDATE_RESET_STAUS = "UPDATE_RESET_STAUS";
export const RESET_GET_RESET_STATUS = "RESET_GET_RESET_STATUS";

// search
export const GET_SUGGESTION = "GET_SUGGESTION";
export const SET_SEARCH = "SET_SEARCH";
export const SET_INFINITY_SEARCH = "SET_INFINITY_SEARCH";
export const PUSH_FILTER = "PUSH_FILTER";
export const REMOVE_FILTER = "REMOVE_FILTER";
export const ACTION_FILTER_STATUS = "ACTION_FILTER_STATUS";

// property
export const PUT_BOOKING_FORM_DATA = "ACTION_BOOKING_FORM_DATA";
export const RESET_FORM="RESET_FORM";

// filter data default
export const FILTERDATABASE ="FILTERDATABASE"
// wizard Form
